      ...
      cleargrid () {
       // const {grid} = this.state;
        ...
        render() {
            ...
            const brandStyle = {
              cursor: 'pointer', // Show pointer cursor when hovering over the brand
            ...
            return ( <div>
              ...
              {' '}
              <div onClick={() => this.refresh() } style={brandStyle}>
              Pathfinding Visualizer -  Pick any Algorithm from below and visualize it !
              </div>
             </Navbar.Brand>
             </Navbar>
               <div>
               <div className="button">
                ...
                Shortest Path from source to destination -  <Image src={yellow} roundedCircle width="25" height="25"/>{' '}
